...
icon = Image.open(r"C:\Users\Naveen\Downloads\bizcard img.jpg")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR",
                   page_icon= icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is developed by *P Navin karthick*!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open(r"C:\Users\Naveen\Downloads\bizcard img.jpg"),width=500)
